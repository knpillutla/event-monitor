...
/*	@Autowired
	...
	public ResponseEntity getTopPackersForPast24Hours(@PathVariable("busName") String busName,
		...
		try {
			...
			Map<String, Map<String, Long>> pickHeatMap = orderCounterService
					.getTopPackPerformersByHourForPast24Hours(busName, locnNbr, numOfDays, numOfTopPerformers);
